  ...
  if (this->output_labels_ && has_anno_type_) {
    ...
    if (anno_type_ == AnnotatedDatum_AnnotationType_BBOX) {
      ...
      if (num_bboxes == 0) {
        ...
        caffe_set<Dtype>(16, -1, batch->label_.mutable_cpu_data());
      } else {
        ...
        for (int item_id = 0; item_id < batch_size; ++item_id) {
          ...
          for (int g = 0; g < anno_vec.size(); ++g) {
            ...
            for (int a = 0; a < anno_group.annotation_size(); ++a) {
              ...
              top_label[idx++] = polygon.x1();
              top_label[idx++] = polygon.y1();
              top_label[idx++] = polygon.x2();
              top_label[idx++] = polygon.y2();
              top_label[idx++] = polygon.x3();
              top_label[idx++] = polygon.y3();
              top_label[idx++] = polygon.x4();
              top_label[idx++] = polygon.y4();
            }
          }
        }
      }
