...
#     bias_prefix='', bias_postfix='_bias', lr_mult=1):
#   if use_bn:
#     # parameters for convolution layer with batchnorm.
#     kwargs = {
...
#     assert from_layer in net.keys()
#     net.conv1_1_ch4 = L.Convolution(net[from_layer], num_output=64, pad=1, kernel_size=3, **kwargs)

#     net.relu1_1 = L.ReLU(net.conv1_1_ch4, in_place=True)
#     net.conv1_2 = L.Convolution(net.relu1_1, num_output=64, pad=1, kernel_size=3, **kwargs)
#     net.relu1_2 = L.ReLU(net.conv1_2, in_place=True)
...
def CreateMultiBoxHead_deconv(net, data_layer="data", num_classes=[], from_layers=[],
        use_objectness=False, normalizations=[], use_batchnorm=True, lr_mult=1, use_polygon = True,
        use_scale=True, min_sizes=[], max_sizes=[], prior_variance = [0.1], denser_prior_boxes=False,
        aspect_ratios=[], steps=[], img_height=0, img_width=0, share_location=True,
        flip=True, clip=True, offset=0.5, inter_layer_depth=[], kernel_size=1, pad=0,
